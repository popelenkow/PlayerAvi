...
// PlayerAvi.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPlayerAviApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPlayerAviApp

CPlayerAviApp::CPlayerAviApp()
{
...
// Единственный объект CPlayerAviApp

CPlayerAviApp theApp;


// инициализация CPlayerAviApp

BOOL CPlayerAviApp::InitInstance()
{
